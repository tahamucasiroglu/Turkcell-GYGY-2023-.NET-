...
{
    public class EFMainCategoryRepository : EfEntityRepositoryBase<MainCategory, SatayimSanaDbContext>, IMainCategoryRepository
    {
        public EFMainCategoryRepository(SatayimSanaDbContext context) : base(context) { }
