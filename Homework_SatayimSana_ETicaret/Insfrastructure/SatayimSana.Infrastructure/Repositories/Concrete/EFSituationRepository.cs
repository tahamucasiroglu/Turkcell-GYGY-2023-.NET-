...
{
    public class EFSituationRepository : EfEntityRepositoryBase<Situation, SatayimSanaDbContext>, ISituationRepository
    {
        public EFSituationRepository(SatayimSanaDbContext context) : base(context) { }
