...
{
    public class EFCategoryFeatureRepository : EfEntityRepositoryBase<CategoryFeature, SatayimSanaDbContext>, ICategoryFeatureRepository
    {
        public EFCategoryFeatureRepository(SatayimSanaDbContext context) : base(context) { }
